...
//        scanner.close();
 ...
 static void imprimirTabuleiro(JogoDaVelha jogo) {
	System.out.println();
 ...
 private static boolean jogadaValida(JogoDaVelha jogo,int posicao) {
	 switch (posicao) {
	 	case 1: return jogo.getTabuleiro()[0][0] == -1;
	    case 2: return jogo.getTabuleiro()[0][1] == -1;
	    case 3: return jogo.getTabuleiro()[0][2] == -1;
	    case 4: return jogo.getTabuleiro()[1][0] == -1;
	    case 5: return jogo.getTabuleiro()[1][1] == -1;
	    case 6: return jogo.getTabuleiro()[1][2] == -1;
	    case 7: return jogo.getTabuleiro()[2][0] == -1;
	    case 8: return jogo.getTabuleiro()[2][1] == -1;
	    case 9: return jogo.getTabuleiro()[2][2] == -1;
 ...
 private static void realizarJogada(JogoDaVelha jogo,int posicao,int jogador) {
	 switch (posicao) {
	    case 1: jogo.getTabuleiro()[0][0] = jogador; break;
	    case 2: jogo.getTabuleiro()[0][1] = jogador; break;
	    case 3: jogo.getTabuleiro()[0][2] = jogador; break;
	    case 4: jogo.getTabuleiro()[1][0] = jogador; break;
	    case 5: jogo.getTabuleiro()[1][1] = jogador; break;
	    case 6: jogo.getTabuleiro()[1][2] = jogador; break;
	    case 7: jogo.getTabuleiro()[2][0] = jogador; break;
	    case 8: jogo.getTabuleiro()[2][1] = jogador; break;
	    case 9: jogo.getTabuleiro()[2][2] = jogador; break;
     default: break;
 }
